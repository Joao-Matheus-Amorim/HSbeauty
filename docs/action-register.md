...
| A-006 | P2 | Dependencias | Atualizar patch/minor seguros restantes. | Backend patch/minor concluido via #135; frontend tem PR #136 aberto. | Revisar CI do #136 e mergear se verde. |
